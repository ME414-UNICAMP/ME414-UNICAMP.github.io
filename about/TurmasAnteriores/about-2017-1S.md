...
* Atividades e notas estão disponíveis na página do Moodle (Ensino Aberto). Você deverá logar com o mesmo usuário e senha que usar para acessar os serviços da DAC. 
...
* Caso o aluno não compareça no dia da Prova 1 ou da Prova 2, deverá enviar justificativa primeiramente pelo email do professor responsável pela disciplina. A justificativa será avaliada pelo professor responsável. A prova substitutiva poderá contemplar qualquer conteúdo ministrado durante o semestre. Data da prova substitutiva: XX/XX/2017.
