...
Cada aluno pega uma folha e recorta 10 tiras de papel. 

Cada tira deverá estar indicada por um número (que representa a Pessoa na foto que será apresentada). Ao lado da indicação do número da Pessoa, coloque um "chute" para a idade da pessoa.

Não consulte seus colegas, coloque o seu "chute" sobra a idade.
...
Grupo X fica responsável por coletar os dados (tiras de papel referentes à Pessoa X) dos chutes referentes à Pessoa X. 

Cada grupo deve entregar uma folha com:

* Título: Pessoa X
* RA e nome de cada membro do grupo X
* estatísticas sumárias (mínimo, máximo, média)
* histograma 
* ramo-e-folhas
