...
>  + votar sim ou não em uma assembleia.

>  + ir ou não almoçar no bandejão.

>  + levar ou não um guarda-chuva num dia nublado. 
...
> * Os termos "sucesso" e "fracasso" são apenas rótulos para os dois resultados possíveis.
