...
<center>
[Vídeo: Pesquisa Eleitorial - JN - 20/08/2018](https://www.youtube.com/watch?v=Q1iSF0hSz4o)
</center>
...
> * Se $n$ suficientemente grande, $$\hat{p}_n=\frac{1}{n}\sum_{i=1}^nX_i\approx N\left(p,\frac{p(1-p)}{n}\right)$$ 

> * E então $Z=\frac{\hat{p}_n-p}{\sqrt{\frac{p(1-p)}{n}}}\approx N(0,1)$ 
