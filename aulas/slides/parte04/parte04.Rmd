...
x <- c(2, 4, 5, 6, 8)
y <- c(48, 56, 64, 60, 72)
dados <- data.frame(anos = x, clientes = y)

ggplot(dados, aes(x=anos, y=clientes)) +
    geom_point(col=mycol[1], size=3) +
    labs(x="Anos de Serviço", y="Número de Clientes") + eixos
```

Qual a correlação entre anos de serviço de número de clientes?
