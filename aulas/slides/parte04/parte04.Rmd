...
ggplot(dados, aes(x, y)) + 
    ...
    labs(x="Tempo de serviço (anos)", y="Número de clientes") +
...
ggplot(fitbit, aes(steps, minutesVeryActive)) + 
    ...
    labs(x="Número de Passos", y="Tempo (min) de atividade intensa") + 
    theme(axis.text=element_text(size=12), 
          axis.title=element_text(size=14, face="bold"))
```
</center>
...
ggplot(fitbit2, aes(steps, minutesSedentary)) + 
    geom_point(col="blue", size=2) +
    labs(x="Número de Passos", y="Tempo (min) sedentário") + 
    theme(axis.text=element_text(size=12), 
          axis.title=element_text(size=14, face="bold"))
```
</center>
...
ggplot(fitbit, aes(steps, distance)) + 
    ...
    labs(x="Número de Passos", y="Distância (km)") + 
    theme(axis.text=element_text(size=12), 
          axis.title=element_text(size=14, face="bold")) 
```
</center>
