...
subtitle: Atividade em Classe 5
output:
...
amostras = rgeo(n=total_amostras, latlim = c(-23.00414,-22.791414), 
                lonlim=c(-47.143304,-46.994937))
write.csv(amostras, file="dados_XXXXXXX.csv") # substitua XXXXXXX pelo RA usado no comando set.seed
...
* O arquivo `dados_XXXXXXX.csv`, substituindo XXXXX pelo RA utilizado no comando `set.seed`. O arquivo deve ter a terceira coluna preenchida com a informação: 1 caso o local tenha ponto de ônibus dentro do raio e 0, caso contrário.
