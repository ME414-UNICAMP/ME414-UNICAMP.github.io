...
> $\displaystyle \mathbb E(\bar X) = 1 \times \frac{1}{4} + 1.5 \times \frac{1}{2} + 2 \times \frac{1}{4} = \frac{3}{2}$
...
> Repare que: $\mathbb E(\bar X) = \mu = \mathbb E(X)$ e $Var(\bar X) = \frac{\sigma^2}{n} = \frac{Var(X)}{n}$.
...
Para uma amostra aleatória simples $X_{1},...,X_{n}$ coletada de uma população com média $\mu$ e variância $\sigma^{2}$, a distribuição amostral de $\bar X_{n}$ aproxima-se de uma **distribuição Normal** de média $\mu$ e variância $\frac{\sigma^{2}}{n}$, quando $n$ for suficientemente grande.
...
$$E\left(\bar X_{100}\right)=\frac{1}{2} \qquad \mbox{e} \qquad Var\left(\bar X_{100}\right)=\frac{1/4}{100}=\frac{1}{400}.$$
