...
$$Z = \frac{\bar X_{n} - \mu}{\sigma / \sqrt{n}} \sim \mathcal{N}(0,1)$$ 
...
> Se temos uma amostra aleatória simples de tamanho $n$: $X_1,X_2,\ldots, X_n$, pelo TLC sabemos que a distribuição amostral de $\bar X_n$ é Normal$\left( 3.5, \frac{2.92}{n} \right)$ para $n$ grande.
