...
> * $\widehat{p} = \frac{S_{n}}{n}$ (média amostral como estimador da média populacional).
...
> *  $\widehat p = \frac{1}{500} \sum_{i=1}^{500} X_i$. 

> *  $\widehat p \sim N\left(0.2, \frac{0.2\times0.8}{500}\right) = N \left(0.2, 0.00032 \right)$ 
...
> * $\widehat p = \frac{S_n}{n} \qquad \Rightarrow \qquad S_n = n\widehat p$. 

> * Quando $n$ é grande o suficiente $\widehat p \sim N \left(p, \frac{p(1-p)}{n}\right)$. 

> * Qual a distribuição de $S_n$ quando n é grande o suficiente?

> * $S_n = X_1 + \ldots + X_n$ 

> * $\widehat p = \frac{S_n}{n} \sim N\left(p, \frac{p(1-p)}{n} \right)$ 
