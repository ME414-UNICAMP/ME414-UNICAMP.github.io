...
library(DT)
datatable(aa, colnames = c(c("Primeira pessoa","Segunda pessoa","ˆp")))
```

## Modo 1 - Exemplo $N=5$ e $n=2$ {.build} {.smaller}
...
datatable(aa, colnames = c(c("Pessoa amostrada 1","Pessoa amostrada 1", "Pessoa amostrada 3", "ˆp")))
```
