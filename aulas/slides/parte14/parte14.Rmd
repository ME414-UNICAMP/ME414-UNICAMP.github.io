...
Seja $X$ uma v.a. com distribuição de Bernoulli com parâmetro $p$. Sabe-se que $\mathbb E(X)=p$ e $Var(X)=p(1-p)$.
...
> * E, conforme $n$ aumenta, vimos nos gráficos que: 
...
kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Pessoa 1", "Pessoa 2","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<center>
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:25,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:26,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[27:40,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[41:54,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[55:68,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[69:82,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[83:96,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[97:110,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[111:125,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2","Pessoa 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
