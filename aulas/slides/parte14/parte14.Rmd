...
> Se temos uma amostra aleatória de tamanho $n$: $X_1,X_2,\ldots, X_n$, pelo TLC sabemos que a distribuição amostral de $\bar X_n$ é Normal$\left( 3.5, \frac{2.92}{n} \right)$ para $n$ grande.
