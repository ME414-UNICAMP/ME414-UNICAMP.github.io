...
#library(DT)
#datatable(aa, colnames = c("Primeira pessoa", "Segunda pessoa", "hat{p}"))
...
kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:26,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[27:40,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[41:54,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[55:68,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[69:82,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[83:96,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[97:110,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[111:125,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
