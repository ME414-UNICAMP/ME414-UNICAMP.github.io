...
## Eleições para a Prefeitura: Estimar uma Proporção  {.build}
...
> * Seja
$$X_i = \begin{cases} 
1, & \text{se a pessoa $i$ vota em $A$} \\
0, & \text{se a pessoa $i$ não vota em $A$}
\end{cases}$$
...
&= \frac{1}{N} \left(\sum_{i=1}^N X_i^2 - 2p \sum_{i=1}^N X_i + \sum_{i=1}^N p^2 \right)\\
&=  \frac{1}{N} \left(\sum_{i=1}^N X_i-2p\sum_{i=1}^N X_i+\sum_{i=1}^N p^2 \right) \\
&=  \frac{1}{N} \left(Np - 2pNp + Np^2 \right) = p(1-p)
\end{aligned}$$
...
&= \frac{1}{5} \left[3\times(1-0.6)^2+2\times(0-0.6)^2 \right] \\
&= 0.24\\
&= p(1-p)
\end{aligned}$$
...
barplot(c(0.4, 0.6), names.arg=namess, col="turquoise3", main="", 
            cex.lab=1.0, cex.axis=1.0, cex.names=1.0, cex.main=2, las=1,
        ylim = c(0, 0.7))
```
...
#library(DT)
#datatable(aa, colnames = c("Pessoa 1", "Pessoa 2", "hat{p}"))

kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Primeira pessoa", "Segunda pessoa","$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
...
<center>
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:25,], align = 'ccc', row.names = T, col.names = c("Primeira pessoa", "Segunda pessoa","$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
$$\begin{aligned} 
\mathbb E(\hat{p}) &= 0\times 0.16 + 0.5\times 0.48 + 1\times 0.36 = 0.6 = p \\
...
#datatable(aa, colnames = c("Pessoa amostrada 1","Pessoa amostrada 2", "Pessoa amostrada 3", "hat{p}"))

kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:26,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[27:40,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[41:54,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[55:68,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[69:82,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[83:96,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[97:110,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[111:125,], align = 'ccc', row.names = T, col.names = c("Pessoa 1","Pessoa 2", "Pessoa 3", "$\\hat{p}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
$$\begin{aligned} 
\mathbb E(\hat p) &= 0\times 0.064 + 0.333\times 0.288 + 0.667\times 0.432 + 1\times 0.216\\
&= 0.6 = p\\
Var(\hat p)&= \mathbb E[(\hat p - p)^2] \\
...
> Suponha que a resposta de uma pessoa da cidade sobre se vota ou não no candidato $A$ possa ser representada por uma **variável aleatória** $X$, tal que $X \sim b(p)$, ou seja:
$$ X = \begin{cases}
...
#datatable(aa, colnames = c("Primeira pessoa","Segunda pessoa", "bar{X}"))

kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Primeira pessoa","Segunda pessoa","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<center>
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:25,], align = 'ccc', row.names = T, col.names = c("Primeira pessoa","Segunda pessoa","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
#datatable(aa, colnames = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3", "bar{X}"))

kable(aa[1:13,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[14:26,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[27:40,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[41:54,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[55:68,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[69:82,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: left; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[83:96,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
<div style="float: right; width: 45%;">
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[97:110,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
kable(aa[111:125,], align = 'ccc', row.names = T, col.names = c("Pessoa amostrada 1","Pessoa amostrada 2","Pessoa amostrada 3","$\\bar{X}$"))  %>%
  row_spec(0, align = "c") %>% 
  kable_styling(position = "left", 
                bootstrap_options = c("striped", "condensed", "bordered"), 
                font_size = 18, full_width = FALSE)
