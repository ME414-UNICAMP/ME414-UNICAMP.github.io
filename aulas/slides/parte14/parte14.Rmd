...
Veja os gráficos das distribuições de probabilidade de $X\sim Bernoulli(p=0.5)$ e $\hat{p}$, respectivamente. 


```{r, echo=FALSE, fig.height=3.5, fig.width=6,fig.align='center'}
par(mfrow=c(1, 2), mar = c(4, 3, 2, 1))
barplot(c(0.5, 0.5), las = 1, col = "turquoise3", ylim = c(0, 1), width = 0.25,
        names.arg = c(0, 1), 
        main = "", xlab = "X", ylab = "", xlim = c(0, 1))
barplot(c(0.25, 0.5, 0.25), las = 1, col = "turquoise3", 
        names.arg = c("0", "1/2", "1"), 
        main = " ", 
...
<br /> 
Sem maiores detalhes, pode-se mostrar que:
...
Os tempos de vida de 100 transistores são coletados e a média dos tempos é calculada, denotada por $\bar X_{100}$.
