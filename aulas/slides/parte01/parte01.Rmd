...
Para que possamos resumir os dados, é importante primeiramente entender como eles são organizados e também os diversos *tipos de variável*.

**Variável**: qualquer característica observável ou mensurável de um indivíduo ou unidade pertencente a uma população.

<img src="figuras/10-classificacaoVariaveis.jpg" width=500 style="float: left; margin-right: 2cm">

**Exemplos**: peso, altura, escolaridade, curso. 
...
**Qualitativa/Categórica**: representam atributos que não são numéricos.

<img src="figuras/10-graficos.jpg" width=400 style="float: right; margin-top:-0.5cm; margin-bottom: -1cm">
  
  * **Nominal**: não possuem uma ordem natural. Ex.: sexo, cor dos olhos.
  * **Ordinal**: apresentam uma ordem ou hierarquia entre as categorias. Ex.: grau de instrução, classe social.

**Quantitativa/Numérica**: representam quantidades expressas por números resultantes de uma contagem ou mensuração.
  
  * **Discreta**: assumem valores inteiros, geralmente provenientes de uma contagem. Ex.: número de filhos, número de carros na família.
  * **Contínua**: assumem qualquer valor dentro de um intervalo, sendo resultado de uma mensuração. Ex.: peso, altura, tempo.


## Comparação entre os Tipos de Variáveis

<img src="figuras/10-comparacaoVariaveis.png" width=700 style="margin-left: 2cm"> 
...
<img src="figuras/10-classificacaoVariaveis.jpg" width=400 style="float: left; margin-right: 2cm; margin-top:0cm">
