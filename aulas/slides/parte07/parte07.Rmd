...
## Teorema de Bayes {.build}
Sejam dois eventos quaisquer $A$ e $B$, tal que $P(A) \neq 0$. 

Pelos resultados anteriores podemos escrever:
...
Essa relação é chamada de **Teorema de Bayes**.
...
> Não sabemos $P(A)$ diretamente, mas podemos calculá-la usando a seguinte fórmula:
...
Estatísticas mostram que a acurácia da mamografia é 80%, ou seja, a probabilidade de detectar o câncer quando este realmente existe. E 9.6% das mamografias resultam em falsos positivos (teste positivo quando o câncer não existe). 
