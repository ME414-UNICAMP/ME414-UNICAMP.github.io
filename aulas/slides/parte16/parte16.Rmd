...
> * Coletar outra a.a. de tamanho $n$ a partir da população com distribuição $X$ e guardar o valor da média desta amostra. 
...
$$ \begin{aligned}
P\left(\mid \bar{X}_n - \mu \mid \leq 1.96\sigma/\sqrt{n}\right)&= P\left( -\sigma/\sqrt{n}\leq \bar{X}_n-\mu \leq \sigma/\sqrt{n} \right)\\
